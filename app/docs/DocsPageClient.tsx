    ...
    <div>
      ...
      {isOpen && <div>Menu content goes here</div>}
        ...
        <section>
          ...
          <p className="mb-3 text-muted-foreground">Simple Usage: Each menu is easy to use:</p>
          <div className="bg-muted p-4 rounded-md mb-4 font-mono text-sm">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-muted-foreground">Learn about all available props and options.</p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-muted-foreground">Test and customize different hamburger menu types.</p>
            </Link>
          </div>
        </section>
      </div>

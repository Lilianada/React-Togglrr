...
interface OffCanvasRevealRightProps {
  isOpen: boolean
  toggle: () => void
...
export function OffCanvasRevealRight({
  isOpen,
  toggle,
  children,
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 bottom-0 z-50 bg-background outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
            style={{ width }}
            role="dialog"
            aria-modal="true"

...
interface OffCanvasStackUpProps {
  isOpen: boolean
  toggle: () => void
...
export function OffCanvasStackUp({
  isOpen,
  toggle,
  children,
  ...
  // StackUp: Each new panel appears above the previous, offset by stackLevel
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 bottom-0 right-0 z-50 bg-background outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
            style={{ height, bottom: stackOffset }}
            role="dialog"
            aria-modal="true"
